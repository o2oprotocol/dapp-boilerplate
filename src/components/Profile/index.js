  ...
  render() {
    ...
    return (
      <div className="profile-wrapper">
                ...
                <div className="row">
                  ...
                  <div className="col-8 col-md-9 name">
                    ...
                    <div className="icon-container">
                      <button className="edit-profile" data-modal="profile" onClick={this.handleToggle}>
            ...
            <div className="col-12 col-lg-8">
              <div className="row">
                ...
                <div className="col-8 col-md-9">
                  <p>
                    This the account I use for lorem ipsum dolor sit amet consectetuer adsplicing nonummy pellentesque
                    curabitur.
                  </p>
                </div>
              </div>
              <div className="services row">
                <div className="col-12 col-sm-6">
                  ...
                  <button className="service" data-modal="twitter" onClick={this.handleToggle}>
                    ...
                    <div
                      ...
                      data-toggle="tooltip"
                      title="To verify your profile, O2OProtocol will have you post a tweet to confirm account ownership"
                    />
                  </button>
                ...
                <div className="col-12 col-sm-6">
                  ...
                  <button className="service" disabled>
                    <div className="icon-container">
                      <img src="/images/icon.svg" alt="O2OProtocol icon" />
                    </div>
                    <p>O2OProtocol</p>
                  </button>
                </div>
            ...
            <div className="col-12 col-lg-4">
              <div className="verification">
                ...
                <p className="status">
                  ...
                  </svg>Not published on O2OProtocol
                </p>
                <h4>Last published to O2OProtocol</h4>
                <p>March 15 @ 12:34pm</p>
                <button className="btn btn-primary" onClick={() => alert("To Do")}>
                  Publish
                </button>
                <div
                  className="info icon-container"
                  data-toggle="tooltip"
                  title="You can edit your profile any time but you will need to publish for others to be able to see it."
                />
              </div>
              <div className="wallet">
                ...
                <p>ETH Address:</p>
                <p>
                  <strong>0x32Be343B94f860124dC4fEe278FDCBD38C102D88</strong>
                </p>
                <hr />
        ...
        <SimpleModal isOpen={this.state.modalsOpen.profile} data-modal="profile" handleToggle={this.handleToggle}>
          <h2>Edit Profile</h2>
          <div className="container">
            <div className="row">
              <div className="col-6">
              ...
              <div className="col-12">
                <div className="button-container">
                  <button className="btn btn-clear" data-modal="profile" onClick={this.handleToggle}>
                    Cancel
                  </button>
                  <button className="btn btn-clear" onClick={() => alert("To Do")}>
                    Continue
                  </button>
                </div>
              </div>
        ...
        <SimpleModal isOpen={this.state.modalsOpen.twitter} data-modal="twitter" handleToggle={this.handleToggle}>
          ...
          <div className="button-container">
            <button className="btn btn-clear" data-modal="twitter" onClick={this.handleToggle}>
              Cancel
            </button>
            <button className="btn btn-clear" onClick={() => alert("To Do")}>
              Continue

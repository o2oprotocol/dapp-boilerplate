...
class TransactionDetail extends Component {
  render() {
    ...
    const { listingId, perspective, data = MOCK_DATA } = this.props
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              {perspective === "buyer" && (
                <p className="brdcrmb">
                  My Purchases{soldAt && <span className="badge badge-success">Purchased</span>}
                </p>
              )}
              {perspective === "seller" && (
                <p className="brdcrmb">My Listings{soldAt && <span className="badge badge-info">Sold</span>}</p>
              )}
              <h1>{listing.title}</h1>
            </div>
          </div>
          <div className="row">
              ...
              <div className="row">
                <div className="col-6">
                  <div className="d-flex">
                    <div className="avatar-container">
                      <img
                        src={`/images/avatar-${perspective === "seller" ? "green" : "blue"}.svg`}
                        alt="seller avatar"
                      />
                    </div>
                ...
                <div className="col-6">
                  <div className="d-flex justify-content-end">
                    ...
                    <div className="avatar-container">
                      <img
                        src={`/images/avatar-${perspective === "buyer" ? "green" : "blue"}.svg`}
                        alt="buyer avatar"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="guidance text-center">
                      ...
                      <p className="instruction">
                        {instruction || "Nothing for you to do at this time. Check back later"}
                      </p>
                      {buttonText && (
            ...
            <div className="col-12 col-lg-4">
              <div className="counterparty">
                <div className="identity">
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <p>ETH Address:</p>
                      <p>
                        <strong>{listing[counterparty].address}</strong>
                      </p>
                    </div>
                  </div>
                  <hr />
                ...
                <a href="/#" className="btn" onClick={() => alert("To Do")}>
                  View Profile
                </a>
              </div>
            </div>
          ...
          <hr />
          <div className="row">
            <div className="col-12 col-lg-8">{/* Listing Details */}</div>
            <div className="col-12 col-lg-4">{/* Status */}</div>
          </div>
        </div>
      </div>
    )
